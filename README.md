...
```
java -jar target/r2financas-core.jar
```
...
```
docker build -t r2financas-core .
```

## Start the application with Docker

```
docker run --rm -p 8080:8080 r2financas-core:latest
```
...
kubectl get service r2financas-core  # Get service info
```
...
```
docker build -t r2financas-core-native -f Dockerfile.native .
```

Start the application:

```
docker run --rm -p 8080:8080 r2financas-core-native:latest
```